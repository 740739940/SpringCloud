package com.zz.module.generator;
...
public class MpGenerator {
    ...
    public static void main(String[] args) {
        //  "/src/main/java"
        final String OUT_PATH = "/zz-provider/src/main/java";
        final String AUTHOR = "zhangzhao";
        final String DB_URL = "jdbc:mariadb://localhost:3306/test?useUnicode=true&useSSL=false&characterEncoding=utf8";
        final String DB_DRIVER = "org.mariadb.jdbc.Driver";
        final String DB_USERNAME = "root";
        final String DB_PASSWORD = "123456";
        final String PACKAGE_DIR = "com.zz.module.generator";
        //多表可,隔开
        final String TABLE_NAME = "t_accsvr";
        //mapper 路径
        final String MAPPER_DIR = "/zz-provider/src/main/resources/mybatis-mapper/";
        //自定义继承的Entity类全称，带包名
